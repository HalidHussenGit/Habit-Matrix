    ...
    <div className="consistency-chart">
      ...
      <div className="chart-container">
        ...
        <svg viewBox="0 0 320 200" className="chart-svg">
          {/* Grid lines */}
          <line x1="20" y1="160" x2="300" y2="160" stroke="#333" strokeWidth="1" />
          <line x1="20" y1="120" x2="300" y2="120" stroke="#333" strokeWidth="1" strokeDasharray="2,2" />
          <line x1="20" y1="80" x2="300" y2="80" stroke="#333" strokeWidth="1" strokeDasharray="2,2" />
          <line x1="20" y1="40" x2="300" y2="40" stroke="#333" strokeWidth="1" strokeDasharray="2,2" />

          {/* Y-axis labels */}
          <text x="10" y="165" fontSize="10" fill="#666" textAnchor="end">0%</text>
          <text x="10" y="125" fontSize="10" fill="#666" textAnchor="end">50%</text>
          <text x="10" y="45" fontSize="10" fill="#666" textAnchor="end">100%</text>
      ...
      <div className="chart-legend">
        <div className="legend-item">
          <div className="legend-color" style={{ backgroundColor: '#6bc86b' }}></div>
